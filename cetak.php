...
<h1 class="mb-5">CETAK STRUK PENJUALAN</h1>
    <table class="data table table-light table-striped table-bordered border-light table-hover py-3 display" id="">
              <thead>
                <tr>
                  <th>No</th>
                  <th>Judul Buku</th>
    ...
    <a class="w-100 btn btn-primary  mt-2" href="cetak_laporan.php?id=<?=$id_fak?>" target="_blank">CETAK</a>
