...
<form method="post">
    <div class="container w-75 mt-3 pt-3">
        ...
        <div data-aos="fade-up" data-aos-delay="300">
          <?php if (@$_GET['id']==""){?>
                  <input class="btn btn-primary active text-light" type="submit" name="simpan" value = "simpan">
                <?php }
                else {?>
                  <input class="btn btn-primary active text-light" type="submit" name="ubah" value="ubah">
                <?php } ?>
        </div>
    </div>
</form>
    ...
    <?php 
          ...
          foreach($data as $r){
              ...
              echo "<tr>
                ...
                <td>".$r['username']."</td>
                <td>".$r['password']."</td>
                <td><a class='btn btn-primary active text-light hover' href=?menu=input_user&hapus&id=".$r['id']." onclick=return confirm('yakin mau hapus?')>Hapus</a></td>
                <td><a class='btn btn-primary active text-light hover' href=?menu=input_user&edit&id=".$r['id'].">Edit</a></td>
              </tr>";
          } 
      ?>
    </tbody>
