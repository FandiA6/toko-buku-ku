...
if(@$data['id_pasok']==" "){
  ...
  if($id_pas <9){
    $id_pas = "PK000000000".( $id_pas+1);
  }
  elseif($id_pas <99){
    $id_pas = "PK00000000".( $id_pas+1);
  }
  elseif($id_pas <999){
    $id_pas = "PK0000000".( $id_pas+1);
  }
  elseif($id_pas <9999){
    $id_pas = "PK000000".( $id_pas+1);
  }
  elseif($id_pas <99999){
    $id_pas = "PK00000".( $id_pas+1);
  }
  elseif($id_pas <999999){
    $id_pas = "PK0000".( $id_pas+1);
  }
  elseif($id_pas <9999999){
    $id_pas = "PK000".( $id_pas+1);
  }
  elseif($id_pas <99999999){
    $id_pas = "PK00".( $id_pas+1);
  }
            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-auto">
                  ...
                  <div class="col-auto"><button type="button" class="btn btn-primary active" data-bs-toggle="modal" data-bs-target="#disModal">CARI Distributor</button></div>
              </div>
            </div>
            <div class="form-group">
              ...
              <Input type="submit" class="mt-3 btn btn-primary active p-2" name="simpan" href="?menu=penjualan&update&id=<?= $tampil['id_buku']?>" value="SIMPAN">
        ...
        <div class="modal" id="exampleModal" tabindex="-1">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-primary active" data-bs-dismiss="modal">Close</button>
              </div>
            </div>
          </div>
        </div>
